...
func (l *UserLoader) Load(key string, params ...interface{}) (*User, error) {
...
func (l *UserLoader) LoadThunk(key string, params ...interface{}) func() (*User, error) {
	l.mu.Lock()
...
func (l *UserLoader) LoadAll(keys []string, params ...interface{}) ([]*User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserLoader) LoadAllThunk(keys []string, params ...interface{}) func() ([]*User, []error) {
	results := make([]func() (*User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key, params...)
	}
...
func (b *userLoaderBatch) keyIndex(l *UserLoader, key string, params ...interface{}) int {
