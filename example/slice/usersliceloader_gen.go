...
func (l *UserSliceLoader) Load(key int, params ...interface{}) ([]example.User, error) {
...
func (l *UserSliceLoader) LoadThunk(key int, params ...interface{}) func() ([]example.User, error) {
	l.mu.Lock()
...
func (l *UserSliceLoader) LoadAll(keys []int, params ...interface{}) ([][]example.User, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *UserSliceLoader) LoadAllThunk(keys []int, params ...interface{}) func() ([][]example.User, []error) {
	results := make([]func() ([]example.User, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key, params...)
	}
...
func (b *userSliceLoaderBatch) keyIndex(l *UserSliceLoader, key int, params ...interface{}) int {
