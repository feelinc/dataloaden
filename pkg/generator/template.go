...
var tpl = template.Must(template.New("generated").
	...
	Parse(`
// Code generated by github.com/feelinc/go-dataloader, DO NOT EDIT.
...
type {{.Name}}Config struct {
	...
	Fetch func(keys []{{.KeyType.String}}, params ...[]interface{}) ([]{{.ValType.String}}, []error)
...
func (l *{{.Name}}) Load(key {{.KeyType.String}}, params ...interface{}) ({{.ValType.String}}, error) {
...
func (l *{{.Name}}) LoadThunk(key {{.KeyType.String}}, params ...interface{}) func() ({{.ValType.String}}, error) {
	l.mu.Lock()
	...
	batch := l.batch
	pos := batch.keyIndex(l, key, params...)
	l.mu.Unlock()
...
func (l *{{.Name}}) LoadAll(keys []{{.KeyType}}, params ...interface{}) ([]{{.ValType.String}}, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *{{.Name}}) LoadAllThunk(keys []{{.KeyType}}, params ...interface{}) (func() ([]{{.ValType.String}}, []error)) {
	results := make([]func() ({{.ValType.String}}, error), len(keys))
 	for i, key := range keys {
		results[i] = l.LoadThunk(key, params...)
	}
...
func (b *{{.Name|lcFirst}}Batch) keyIndex(l *{{.Name}}, key {{.KeyType}}, params ...interface{}) int {
